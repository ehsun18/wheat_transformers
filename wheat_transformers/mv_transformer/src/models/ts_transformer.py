...
class TransformerBatchNormEncoderLayer(nn.modules.Module):
    ...
    # , is_causal=False is added below by HN; I get the error:
    # TypeError: TransformerBatchNormEncoderLayer.forward() got an unexpected keyword argument 'is_causal'
    # and chatGPT said to do it:
    # PyTorch (starting from v2.0+) added is_causal as an optional argument to the forward() method of nn.TransformerEncoderLayer ....
    def forward(
        self,
        src: Tensor,
